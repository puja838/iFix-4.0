...
func (dbc DbConn) GetAllMstprocessadmin(page *entities.MstprocessadminEntity) ([]entities.MstprocessadminEntity, error) {
	logger.Log.Println("In side GelAllMstprocessadmin")
	values := []entities.MstprocessadminEntity{}
	rows, err := dbc.DB.Query(getMstprocessadmin, page.Clientid, page.Mstorgnhirarchyid, page.Offset, page.Limit)
	defer rows.Close()
	if err != nil {
...
func (dbc DbConn) GetMstprocessadminCount(tz *entities.MstprocessadminEntity) (entities.MstprocessadminEntities, error) {
