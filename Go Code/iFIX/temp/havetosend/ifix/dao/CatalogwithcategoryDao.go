...
func (dbc DbConn) GetAllCatalogwithcategory(page *entities.CatalogwithcategoryEntity) ([]entities.CatalogwithcategoryEntity, error) {
	logger.Log.Println("In side GelAllCatalogwithcategory")
	values := []entities.CatalogwithcategoryEntity{}
...
func (dbc DbConn) GetCatalogwithcategoryCount(tz *entities.CatalogwithcategoryEntity) (entities.CatalogwithcategoryEntities, error) {
