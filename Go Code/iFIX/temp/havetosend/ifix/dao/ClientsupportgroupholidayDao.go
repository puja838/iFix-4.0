...
func (dbc DbConn) GetAllClientsupportgroupholiday(page *entities.ClientsupportgroupholidayEntity) ([]entities.ClientsupportgroupholidayEntity, error) {
...
func (dbc DbConn) GetClientsupportgroupholidayCount(tz *entities.ClientsupportgroupholidayEntity) (entities.ClientsupportgroupholidayEntities, error) {
