...
func (dbc DbConn) GetAllMstcategorytaskmap(page *entities.MstcategorytaskmapEntity) ([]entities.MstcategorytaskmapEntity, error) {
...
func (dbc DbConn) GetMstcategorytaskmapCount(tz *entities.MstcategorytaskmapEntity) (entities.MstcategorytaskmapEntities, error) {
