...
var getprocessgroupbyorgid = "SELECT distinct a.grpid,b.name,a.supportgrouplevelid levelid from mstclientsupportgroup a,mstsupportgrp b where a.clientid=? and a.mstorgnhirarchyid=? and isworkflow='Y' and a.grpid = b.id and a.activeflg=1 and a.deleteflg = 0  and b.activeflg=1 and b.deleteflg=0"
