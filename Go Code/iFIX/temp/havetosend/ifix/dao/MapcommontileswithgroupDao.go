...
func (dbc DbConn) GetAllMapcommontileswithgroup(page *entities.MapcommontileswithgroupEntity) ([]entities.MapcommontileswithgroupEntity, error) {
...
func (dbc DbConn) GetMapcommontileswithgroupCount(tz *entities.MapcommontileswithgroupEntity) (entities.MapcommontileswithgroupEntities, error) {
