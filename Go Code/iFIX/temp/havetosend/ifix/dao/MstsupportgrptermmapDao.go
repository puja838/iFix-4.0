...
func (dbc DbConn) GetAllMstsupportgrptermmap(page *entities.MstsupportgrptermmapEntity, OrgnType int64) ([]entities.MstsupportgrptermmapEntity, error) {
	logger.Log.Println("In side GelAllMstsupportgrptermmap")
	values := []entities.MstsupportgrptermmapEntity{}

	var getMstsupportgrptermmap string
	var params []interface{}
	if OrgnType == 1 {
		getMstsupportgrptermmap = "SELECT a.id as Id, a.clientid as Clientid, a.mstorgnhirarchyid as Mstorgnhirarchyid, a.termid as termid, a.grpid as Grpid, a.activeflg as Activeflg,b.name as Clientname, c.name  as Mstorgnhirarchyname, d.termname as Termname, e.name  as Grpname,a.readpermission,a.writepermission  FROM mstsupportgrptermmap a , mstclient b, mstorgnhierarchy c ,mstrecordterms d,mstsupportgrp e WHERE a.activeflg=1 and a.deleteflg =0 and a.clientid=b.id and a.mstorgnhirarchyid=c.id and a.termid=d.id and a.grpid=e.id AND d.deleteflg=0 AND d.activeflg=1 AND e.activeflg=1 AND e.deleteflg=0 ORDER BY a.id DESC LIMIT ?,?"
		params = append(params, page.Offset)
		params = append(params, page.Limit)
	} else if OrgnType == 2 {
		getMstsupportgrptermmap = "SELECT a.id as Id, a.clientid as Clientid, a.mstorgnhirarchyid as Mstorgnhirarchyid, a.termid as termid, a.grpid as Grpid, a.activeflg as Activeflg,b.name as Clientname, c.name  as Mstorgnhirarchyname, d.termname as Termname, e.name  as Grpname,a.readpermission,a.writepermission  FROM mstsupportgrptermmap a , mstclient b, mstorgnhierarchy c ,mstrecordterms d,mstsupportgrp e WHERE a.clientid=? and a.activeflg=1 and a.deleteflg =0 and a.clientid=b.id and a.mstorgnhirarchyid=c.id and a.termid=d.id and a.grpid=e.id AND d.deleteflg=0 AND d.activeflg=1 AND e.activeflg=1 AND e.deleteflg=0 ORDER BY a.id DESC LIMIT ?,?"
		params = append(params, page.Clientid)
		params = append(params, page.Offset)
		params = append(params, page.Limit)
	} else {
		getMstsupportgrptermmap = "SELECT a.id as Id, a.clientid as Clientid, a.mstorgnhirarchyid as Mstorgnhirarchyid, a.termid as termid, a.grpid as Grpid, a.activeflg as Activeflg,b.name as Clientname, c.name  as Mstorgnhirarchyname, d.termname as Termname, e.name  as Grpname,a.readpermission,a.writepermission  FROM mstsupportgrptermmap a , mstclient b, mstorgnhierarchy c ,mstrecordterms d,mstsupportgrp e WHERE a.clientid=? and a.mstorgnhirarchyid=? and a.activeflg=1 and a.deleteflg =0 and a.clientid=b.id and a.mstorgnhirarchyid=c.id and a.termid=d.id and a.grpid=e.id AND d.deleteflg=0 AND d.activeflg=1 AND e.activeflg=1 AND e.deleteflg=0 ORDER BY a.id DESC LIMIT ?,?"
		params = append(params, page.Clientid)
		params = append(params, page.Mstorgnhirarchyid)
		params = append(params, page.Offset)
		params = append(params, page.Limit)
	}
	rows, err := dbc.DB.Query(getMstsupportgrptermmap, params...)
...
func (dbc DbConn) GetMstsupportgrptermmapCount(tz *entities.MstsupportgrptermmapEntity, OrgnTypeID int64) (entities.MstsupportgrptermmapEntities, error) {
	logger.Log.Println("In side GetMstsupportgrptermmapCount")
	value := entities.MstsupportgrptermmapEntities{}

	var getMstsupportgrptermmapcount string
	var params []interface{}
	if OrgnTypeID == 1 {
		getMstsupportgrptermmapcount = "SELECT count(a.id) total FROM mstsupportgrptermmap a , mstclient b, mstorgnhierarchy c ,mstrecordterms d,mstsupportgrp e WHERE a.activeflg=1 and a.deleteflg =0 and a.clientid=b.id and a.mstorgnhirarchyid=c.id and a.termid=d.id and a.grpid=e.id AND d.deleteflg=0 AND d.activeflg=1 AND e.activeflg=1 AND e.deleteflg=0 "
	} else if OrgnTypeID == 2 {
		getMstsupportgrptermmapcount = "SELECT count(a.id) total FROM mstsupportgrptermmap a , mstclient b, mstorgnhierarchy c ,mstrecordterms d,mstsupportgrp e WHERE a.clientid=? and a.activeflg=1 and a.deleteflg =0 and a.clientid=b.id and a.mstorgnhirarchyid=c.id and a.termid=d.id and a.grpid=e.id AND d.deleteflg=0 AND d.activeflg=1 AND e.activeflg=1 AND e.deleteflg=0 "
		params = append(params, tz.Clientid)
	} else {
		getMstsupportgrptermmapcount = "SELECT count(a.id) total FROM mstsupportgrptermmap a , mstclient b, mstorgnhierarchy c ,mstrecordterms d,mstsupportgrp e WHERE a.clientid=? and a.mstorgnhirarchyid=? and a.activeflg=1 and a.deleteflg =0 and a.clientid=b.id and a.mstorgnhirarchyid=c.id and a.termid=d.id and a.grpid=e.id AND d.deleteflg=0 AND d.activeflg=1 AND e.activeflg=1 AND e.deleteflg=0 "
		params = append(params, tz.Clientid)
		params = append(params, tz.Mstorgnhirarchyid)
	}
	err := dbc.DB.QueryRow(getMstsupportgrptermmapcount, params...).Scan(&value.Total)
