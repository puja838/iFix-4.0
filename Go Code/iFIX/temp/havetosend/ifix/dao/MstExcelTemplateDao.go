...
func (dbc DbConn) GetAllMstExcelTemplate(page *entities.MstExcelTemplateEntity) ([]entities.MstExcelTemplateEntity, error) {
...
func (dbc DbConn) GetMstExcelTemplateCount(tz *entities.MstExcelTemplateEntity) (entities.MstExcelTemplateEntities, error) {
