...
func (dbc DbConn) GetAllBanner(page *entities.BannerEntity) ([]entities.BannerEntity, error) {
...
func (dbc DbConn) GetBannerCount(tz *entities.BannerEntity) (entities.BannerEntities, error) {
