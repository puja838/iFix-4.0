...
//PaginationEntity is used for pagination
...
func DbErrorResponse() APIResponse {
	var response = APIResponse{}
	response.Status = false
	response.Message = "503 Database Error."
	return response
}
...
func (w *PaginationEntity) FromJSON(r io.Reader) error {
	e := json.NewDecoder(r)
	return e.Decode(w)
}
