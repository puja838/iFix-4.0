...
func (dbc DbConn) GetAllMstrecordfield(page *entities.MstrecordfieldEntity) ([]entities.MstrecordfieldEntity, error) {
...
func (dbc DbConn) GetMstrecordfieldCount(tz *entities.MstrecordfieldEntity) (entities.MstrecordfieldEntities, error) {
