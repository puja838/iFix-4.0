...
func (dbc DbConn) GetAllAssetdifferentiation(page *entities.AssetdifferentiationEntity) ([]entities.AssetdifferentiationEntity, error) {
...
func (dbc DbConn) GetAssetdifferentiationCount(tz *entities.AssetdifferentiationEntity) (entities.AssetdifferentiationEntities, error) {
