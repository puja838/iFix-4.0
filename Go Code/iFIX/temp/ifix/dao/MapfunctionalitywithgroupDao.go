...
func (dbc DbConn) GetAllMapfunctionalitywithgroup(page *entities.MapfunctionalitywithgroupEntity) ([]entities.MapfunctionalitywithgroupResponseEntity, error) {
...
func (dbc DbConn) GetMapfunctionalitywithgroupCount(tz *entities.MapfunctionalitywithgroupEntity) (entities.MapfunctionalitywithgroupEntities, error) {
