...
func (dbc DbConn) GetAllTaskmapvalues(page *entities.RecordtypeEntity, OrgnType int64) ([]entities.RecordtypeEntity, error) {
	...
	var params []interface{}
	if OrgnType == 1 {
		getRecordtype = "SELECT a.id as Id, a.clientid as Clientid, a.mstorgnhirarchyid as Mstorgnhirarchyid, a.fromrecorddifftypeid as Fromrecorddifftypeid, a.fromrecorddiffid as Fromrecorddiffid, a.torecorddifftypeid as Torecorddifftypeid, a.torecorddiffid as Torecorddiffid, a.activeflg as Activeflg,b.name as Clientname,c.name as Mstorgnhirarchyname,d.typename as Fromrecorddifftypename,e.name as Fromrecorddiffname,f.typename as Torecorddifftypename,COALESCE(g.name,'NA') AS Torecorddiffname,COALESCE(h.title,''),COALESCE(h.description,'') FROM mstclient b,mstorgnhierarchy c,mstrecorddifferentiationtype d,mstrecorddifferentiation e,mstrecorddifferentiationtype f,msttaskpropertyvalue h,mstrecordtype a LEFT JOIN mstrecorddifferentiation g ON a.torecorddiffid = g.id WHERE h.recordtypeid=a.id AND a.deleteflg =0 and a.activeflg=1 and a.clientid =b.id AND a.mstorgnhirarchyid = c.id and a.fromrecorddifftypeid=d.id and a.fromrecorddiffid=e.id and a.torecorddifftypeid=f.id ORDER BY a.id DESC LIMIT ?,?"
		params = append(params, page.Offset)
		params = append(params, page.Limit)
	} else if OrgnType == 2 {
		getRecordtype = "SELECT a.id as Id, a.clientid as Clientid, a.mstorgnhirarchyid as Mstorgnhirarchyid, a.fromrecorddifftypeid as Fromrecorddifftypeid, a.fromrecorddiffid as Fromrecorddiffid, a.torecorddifftypeid as Torecorddifftypeid, a.torecorddiffid as Torecorddiffid, a.activeflg as Activeflg,b.name as Clientname,c.name as Mstorgnhirarchyname,d.typename as Fromrecorddifftypename,e.name as Fromrecorddiffname,f.typename as Torecorddifftypename,COALESCE(g.name,'NA') AS Torecorddiffname,COALESCE(h.title,''),COALESCE(h.description,'') FROM mstclient b,mstorgnhierarchy c,mstrecorddifferentiationtype d,mstrecorddifferentiation e,mstrecorddifferentiationtype f,msttaskpropertyvalue h,mstrecordtype a LEFT JOIN mstrecorddifferentiation g ON a.torecorddiffid = g.id WHERE h.clientid = ? AND h.recordtypeid=a.id AND a.deleteflg =0 and a.activeflg=1 and a.clientid =b.id AND a.mstorgnhirarchyid = c.id and a.fromrecorddifftypeid=d.id and a.fromrecorddiffid=e.id and a.torecorddifftypeid=f.id ORDER BY a.id DESC LIMIT ?,?"
		params = append(params, page.Clientid)
		params = append(params, page.Offset)
		params = append(params, page.Limit)
	} else {
		getRecordtype = "SELECT a.id as Id, a.clientid as Clientid, a.mstorgnhirarchyid as Mstorgnhirarchyid, a.fromrecorddifftypeid as Fromrecorddifftypeid, a.fromrecorddiffid as Fromrecorddiffid, a.torecorddifftypeid as Torecorddifftypeid, a.torecorddiffid as Torecorddiffid, a.activeflg as Activeflg,b.name as Clientname,c.name as Mstorgnhirarchyname,d.typename as Fromrecorddifftypename,e.name as Fromrecorddiffname,f.typename as Torecorddifftypename,COALESCE(g.name,'NA') AS Torecorddiffname,COALESCE(h.title,''),COALESCE(h.description,'') FROM mstclient b,mstorgnhierarchy c,mstrecorddifferentiationtype d,mstrecorddifferentiation e,mstrecorddifferentiationtype f,msttaskpropertyvalue h,mstrecordtype a LEFT JOIN mstrecorddifferentiation g ON a.torecorddiffid = g.id WHERE h.clientid = ? AND h.mstorgnhirarchyid = ? AND h.recordtypeid=a.id AND a.deleteflg =0 and a.activeflg=1 and a.clientid =b.id AND a.mstorgnhirarchyid = c.id and a.fromrecorddifftypeid=d.id and a.fromrecorddiffid=e.id and a.torecorddifftypeid=f.id ORDER BY a.id DESC LIMIT ?,?"
		params = append(params, page.Clientid)
		params = append(params, page.Mstorgnhirarchyid)
		params = append(params, page.Offset)
		params = append(params, page.Limit)
...
func (dbc DbConn) GettaskmapCount(tz *entities.RecordtypeEntity, OrgnTypeID int64) (entities.RecordtypeEntities, error) {
	...
	var params []interface{}
	if OrgnTypeID == 1 {
		getRecordtypecount = "SELECT count(a.id) as total FROM mstrecordtype a,mstclient b,mstorgnhierarchy c,mstrecorddifferentiationtype d,mstrecorddifferentiation e,mstrecorddifferentiationtype f,mstrecorddifferentiation g,msttaskpropertyvalue h WHERE h.recordtypeid=a.id AND h.deleteflg =0 and h.activeflg=1 AND a.deleteflg =0 and a.activeflg=1 and a.clientid =b.id AND a.mstorgnhirarchyid = c.id and a.fromrecorddifftypeid=d.id and a.fromrecorddiffid=e.id and a.torecorddifftypeid=f.id and a.torecorddiffid=g.id"
	} else if OrgnTypeID == 2 {
		getRecordtypecount = "SELECT count(a.id) as total FROM mstrecordtype a,mstclient b,mstorgnhierarchy c,mstrecorddifferentiationtype d,mstrecorddifferentiation e,mstrecorddifferentiationtype f,mstrecorddifferentiation g,msttaskpropertyvalue h WHERE h.clientid = ? AND h.recordtypeid=a.id AND h.deleteflg =0 and h.activeflg=1 AND a.deleteflg =0 and a.activeflg=1 and a.clientid =b.id AND a.mstorgnhirarchyid = c.id and a.fromrecorddifftypeid=d.id and a.fromrecorddiffid=e.id and a.torecorddifftypeid=f.id and a.torecorddiffid=g.id"
		params = append(params, tz.Clientid)
	} else {
