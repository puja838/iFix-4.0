...
func (dbc DbConn) GetClietWiseAsset(page *entities.AssetEntity) ([]entities.AssetMapWithRecordType, error) {
...
func (dbc DbConn) CountClietWiseAsset(page *entities.AssetEntity) (entities.AssetEntities, error) {
