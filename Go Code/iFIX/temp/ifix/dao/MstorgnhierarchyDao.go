...
var organizationinsert = "INSERT INTO mstorgnhierarchy(clientid,parentid,mstorgnhierarchytypeid,name,cityid,countryid,code,location,timezoneid,reporttimezoneid ,logintypeid,timeformatid,activationdate,reporttimeformatid,islocallogin ) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,round(UNIX_TIMESTAMP(?)),?,?)"
...
var organizationupdate = "UPDATE mstorgnhierarchy SET clientid=?,parentid=?,mstorgnhierarchytypeid=?,name=?,cityid=?,countryid=?,code=?,location=?,timezoneid=?,reporttimezoneid=?,activationdate=round(UNIX_TIMESTAMP(?)),timeformatid=?,logintypeid=?,reporttimeformatid=?,islocallogin=? WHERE id=?"
...
func (mdao DbConn) InsertOrganization(data *entities.MstorgnhierarchyEntity) (int64, error) {
	...
	res, err := stmt.Exec(data.ClientID, data.ParentID, data.MstorgnhierarchytypeID, data.Organizationname, data.CityID, data.CountryID, data.Code, data.Location, data.TimezoneID, data.ReporttimezoneID, data.LogintypeID, data.Timeformatid, data.Activationdate, data.ReportTimeformatid, data.Islocallogin)
	if err != nil {
...
func (mdao DbConn) UpdateOrganization(data *entities.MstorgnhierarchyEntity) error {
	...
	_, err = stmt.Exec(data.ClientID, data.ParentID, data.MstorgnhierarchytypeID, data.Organizationname, data.CityID, data.CountryID, data.Code, data.Location, data.TimezoneID, data.ReporttimezoneID, data.Activationdate, data.Timeformatid, data.LogintypeID, data.ReportTimeformatid, data.Islocallogin, data.ID)
	if err != nil {
...
func (mdao DbConn) GetAllOrganization(page *entities.MstorgnhierarchyEntity) ([]entities.MstorgnhierarchyEntity, error) {
	...
	for rows.Next() {
		...
		err = rows.Scan(&value.ID, &value.ClientID, &value.ParentID, &value.MstorgnhierarchytypeID, &value.Organizationname, &value.CityID, &value.CountryID, &value.Code, &value.Location, &value.TimezoneID, &value.ReporttimezoneID, &value.Activationdate, &value.Clientname, &value.Parentname, &value.Mstorgnhierarchytypename, &value.Cityname, &value.Countryname, &value.Timezonename, &value.Reporttimezonename, &value.Islocallogin, &value.Timeformat, &value.LogintypeID, &value.LogintypeName, &value.ReportTimeformatid, &value.Timeformatid, &value.ReportTimeformat)
