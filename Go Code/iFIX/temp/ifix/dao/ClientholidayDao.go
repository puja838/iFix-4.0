...
func (dbc DbConn) GetAllClientholiday(page *entities.ClientholidayEntity) ([]entities.ClientholidayEntity, error) {
...
func (dbc DbConn) GetClientholidayCount(tz *entities.ClientholidayEntity) (entities.ClientholidayEntities, error) {
