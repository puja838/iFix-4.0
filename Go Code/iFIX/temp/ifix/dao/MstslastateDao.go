...
func (dbc DbConn) GetAllMstslastate(page *entities.MstslastateEntity) ([]entities.MstslastateEntity, error) {
...
func (dbc DbConn) GetMstslastateCount(tz *entities.MstslastateEntity) (entities.MstslastateEntities, error) {
