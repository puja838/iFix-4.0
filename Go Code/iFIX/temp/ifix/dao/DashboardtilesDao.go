...
func (mdao DbConn) GetTilesnamesUserspecific(page *entities.DashboardtilesinputEntity) ([]entities.DashboardtilesresponseEntity, error) {
	...
	rows, err := mdao.DB.Query(userspecifictiles, page.Clientid, page.Mstorgnhirarchyid, page.Recorddifftypeid, page.Recorddiffid, page.UserID, page.GroupID, page.Ismanagerialview)
	defer rows.Close()
	if err != nil {
...
func (mdao DbConn) GetTilesnamesgroupspecific(page *entities.DashboardtilesinputEntity) ([]entities.DashboardtilesresponseEntity, error) {
	...
	values := []entities.DashboardtilesresponseEntity{}
	rows, err := mdao.DB.Query(groupspecifictiles, page.Clientid, page.Mstorgnhirarchyid, page.Recorddifftypeid, page.Recorddiffid, page.GroupID, page.Ismanagerialview)
	defer rows.Close()
	if err != nil {
