...
func (dbc DbConn) GetAllMaprecordstatetodifferentiation(page *entities.MaprecordstatetodifferentiationEntity) ([]entities.MaprecordstatetodifferentiationEntity, error) {
...
func (dbc DbConn) GetMaprecordstatetodifferentiationCount(tz *entities.MaprecordstatetodifferentiationEntity) (entities.MaprecordstatetodifferentiationEntities, error) {
