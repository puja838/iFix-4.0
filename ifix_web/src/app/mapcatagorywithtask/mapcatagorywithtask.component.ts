...
@Component({
  selector: 'app-mapcatagorywithtask',
  templateUrl: './mapcatagorywithtask.component.html',
  styleUrls: ['./mapcatagorywithtask.component.css']
})
export class MapcatagorywithtaskComponent implements OnInit {
 displayed = true;
  moduleName: string;
  description: string;
  totalData = 0;
        ...
        case 'delete':
          ...
          if (!this.del) {
            ...
            if (confirm('Are you sure?')) {
              ...
              this.rest.deletecategorytaskmap({id: item.id}).subscribe((res) => {
                this.respObject = res;
  ...
  ngOnInit(): void {
    ...
    this.displayData = {
      pageName: 'Maintain Category Task Mapping',
      openModalButton: 'Category Task Mapping',
      breadcrumb: 'Category Task Mapping',
      folderName: 'Category Task Mapping',
      tabName: 'Category Task Mapping'
    };
    ...
    const columnDefinitions = [
      ...
      },
      {
        ...
        //   =====================================
          ...
          this.fromRecDiffId = args.dataContext.fromtickettypediffid;
          this.totickettypedifftypeid = args.dataContext.totickettypedifftypeid;
          this.toRecDiffId = args.dataContext.totickettypediffid;
          this.fromtickettypedifftypeidcat = args.dataContext.fromcatdifftypeid,
          this.totickettypedifftypeidcat=args.dataContext.tocatdifftypeid,
      ...
      {
        id: 'fromtickettypedifftypename', name: 'From Property Type ', field: 'fromtickettypedifftypename', sortable: true, filterable: true
      },
      {
        id: 'fromtickettypediffname', name: 'From Property ', field: 'fromtickettypediffname', sortable: true, filterable: true
      },
      {
        id: 'fromcatdifftypename', name: 'From Property Category Type ', field: 'fromcatdifftypename', sortable: true, filterable: true
      },
      {
        id: 'fromcatlabelname', name: 'From Property Category Lavel ', field: 'fromcatlabelname', sortable: true, filterable: true
      },
      {
        id: 'fromcatdiffname', name: 'From Property Category', field: 'fromcatdiffname', sortable: true, filterable: true
      },
      {
        id: 'totickettypedifftypename', name: 'To Property Type ', field: 'totickettypedifftypename', sortable: true, filterable: true
      },
      {
        id: 'totickettypediffname', name: 'To Property', field: 'totickettypediffname', sortable: true, filterable: true
      },
      {
        id: 'tocatdifftypename', name: 'To Property Category Type ', field: 'tocatdifftypename', sortable: true, filterable: true
      },
      {
        id: 'tocatlabelname', name: 'To Property Category Lavel ', field: 'tocatlabelname', sortable: true, filterable: true
      },
      {
        id: 'tocatdiffnam', name: 'To Property Category', field: 'tocatdiffnam', sortable: true, filterable: true
      },
    ];
  ...
  getData(paginationObj) {
    ...
    //console.log(data);
    this.rest.getcategorytaskmap(data).subscribe((res) => {
      this.respObject = res;
  ...
  save() {
    ...
    clientid:this.clientId,
    mstorgnhirarchyid:Number(this.organizationId),
    fromtickettypediffid:Number(this.fromRecordDiffId),
    fromcatdifftypeid:Number(this.fromtickettypedifftypeidcat),
    fromcatlabelid:Number(this.fromlevelcatgid),
    fromcatdiffid:Number(this.fromRecordDiffCatg),
    totickettypediffid:Number(this.toRecordDiffId),
    tocatdifftypeid:Number(this.totickettypedifftypeidcat),
    tocatlabelid:Number(this.tolevelcatgid),
    tocatdiffid:Number(this.toRecordDiffCatg)
  };
    if (this.fromPropLevels.length === 0) {
      data['fromtickettypedifftypeid'] = Number(this.fromtickettypedifftypeid);
    } else {
      data['fromtickettypedifftypeid'] = Number(this.fromlevelid);
    }

    if (this.toPropLevels.length === 0) {
      data['totickettypedifftypeid'] = Number(this.totickettypedifftypeid);
    } else {
      data['totickettypedifftypeid'] = Number(this.tolevelid);
    }
    if (!this.messageService.isBlankField(data)) {
      console.log(JSON.stringify(data));
      this.rest.addcategorytaskmap(data).subscribe((res) => {
        this.respObject = res;
        if (this.respObject.success) {
          ...
          this.messageService.setRow({
            ...
            fromtickettypedifftypeid:this.fromtickettypedifftypeid,
            ...
            totickettypedifftypename: this.totickettypedifftypename,
            totickettypediffname:this.totickettypediffname,
            tocatdifftypename:this.tocatdifftypename,
            tocatlabelname:this.tocatlabelname,
            tocatdiffnam:this.tocatdiffnam,
            fromtickettypediffid:this.fromRecordDiffId,
            totickettypedifftypeid: this.totickettypedifftypeid,
            totickettypediffid: this.toRecordDiffId,
            fromcatdifftypeid:this.fromtickettypedifftypeidcat,
  ...
  update() {
    ...
    if (!this.messageService.isBlankField(data)) {
      this.rest.updatecategorytaskmap(data).subscribe((res) => {
        this.respObject = res;
        if (this.respObject.success) {
      ...
      if (res.success) {
        if (flag === 'from') {
          ...
          for(let i=0;i< this.formTicketTypeListCatg.length;i++){
            //console.log( this.formTicketTypeListCatg[i].parentname)
            if( this.formTicketTypeListCatg[i].parentname!=''){
              //console.log("IFFFFFFFFFF")
              // this.respObject.details.unshift({id: 0, typename: 'Property Value'})
              this.formTicketTypeListCatg[i].typename = this.formTicketTypeListCatg[i].typename.concat("(" + this.formTicketTypeListCatg[i].parentname + ")")
          ...
          for(let i=0;i< this.toTicketTypeListCatg.length;i++){
            //console.log( this.toTicketTypeListCatg[i].parentname)
            if( this.toTicketTypeListCatg[i].parentname!=''){
              //console.log("IFFFFFFFFFF")
              // this.respObject.details.unshift({id: 0, typename: 'Property Value'})
              this.toTicketTypeListCatg[i].typename = this.toTicketTypeListCatg[i].typename.concat("(" + this.toTicketTypeListCatg[i].parentname + ")")
