...
@Component({
  selector: 'app-material-fileupload-singleclick',
  templateUrl: './material-fileupload-singleclick.component.html',
  styleUrls: ['./material-fileupload-singleclick.component.css'],
  animations: [
    trigger('fadeInOut', [
...
export class MaterialFileuploadSingleclickComponent implements OnInit {
  ...
  INVALID_EXT = ['.js', '.json', '.exe', '.jar', '.bat', '.deb', '.asp', '.php', '.py', '.dll', '.vbs'];
