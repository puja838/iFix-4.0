...
@Component({
    selector: 'app-material-fileupload',
    templateUrl: './material-fileupload.component.html',
    styleUrls: ['./material-fileupload.component.css'],
    animations: [
        trigger('fadeInOut', [
...
export class MaterialFileuploadComponent implements OnInit {
    ...
    /** maximum file size **/
    @Input() MAX_FILE_SIZE = 5 * 1024 * 1024; // 2 mb
            ...
            if (fileUpload.files.length <= this.maxFile) {
                for (let index = 0; index < fileUpload.files.length; index++) {
                    ...
                    if (this.INVALID_EXT.indexOf(ext) > -1) {
                        ...
                        this.uploadError.emit('Maximum file size 5 MB exceeded');
                    } else {
